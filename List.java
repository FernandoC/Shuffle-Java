...
// Description: Double ended Linked List
//////////////////////////////////////////////
...
class List{
    ...
    //equals(List L): Returns true if this List and L are the same integer sequence
    ...
    //insertFront(int data): Inserts new element before the front element.
    //Post: !isEmpty()
    ...
    //insertBack(int data): Inserts new element after the back element.
    //Post: !isEmpty().
    ...
    //insertBeforeCurrent (int data): Inserts new element before current element.
    // Pre: !isEmpty(), !offEnd()
    ...
    //insertAfterCurrent (int data): Inserts new element after current element.
    // Pre: !isEmpty(), !offEnd()
